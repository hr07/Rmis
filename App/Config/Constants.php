...
define("ICONS", array(
    "products" =>
    Directories::getLocation("resources/assets/clothes-hanger.png"),
    "comments" =>
    Directories::getLocation("resources/assets/chat-box.png"),
    "messages" =>
    Directories::getLocation("resources/assets/messages.png"),
    "subscriptions" =>
    Directories::getLocation("resources/assets/subscription.png"),
    "orders" =>
    Directories::getLocation("resources/assets/order.png"),
    "customers" =>
    Directories::getLocation("resources/assets/customer.png"),
    "transactions" =>
    Directories::getLocation("resources/assets/budget.png"),
    "category" =>
    Directories::getLocation("resources/assets/category.png"),
    "sub-category" =>
    Directories::getLocation("resources/assets/options.png"),
    "suppliers" =>
    Directories::getLocation("resources/assets/delivery-courier.png"),
    "administrators" =>
    Directories::getLocation("resources/assets/software-engineer.png"),
    "profile" =>
    Directories::getLocation("resources/assets/man.png"),
    "gender" =>
    Directories::getLocation("resources/assets/gender-symbols.png"),
    "users" =>
    Directories::getLocation("resources/assets/user.png"),
    "employees" =>
    Directories::getLocation("resources/assets/employee.png"),
    "notifications" =>
    Directories::getLocation("resources/assets/notification.png"),
    "blogs" =>
    Directories::getLocation("resources/assets/blog.png"),
    "delete" =>
    Directories::getLocation("resources/assets/delete.png"),
    "open-folder" =>
    Directories::getLocation("resources/assets/open-folder.png"),
    "update" =>
    Directories::getLocation("resources/assets/refresh.png"),
    "not-set" =>
    Directories::getLocation("resources/assets/man2.png"),
    "sign out" =>
    Directories::getLocation("resources/assets/switch.png"),
    "update profile" =>
    Directories::getLocation("resources/assets/profile.png"),
    "view activity" =>
    Directories::getLocation("resources/assets/activity.png"),
    "add" =>
    Directories::getLocation("resources/assets/plus-sign.png"),
    "login" =>
    Directories::getLocation("resources/assets/log-in.png"),
    "facebook" =>
    Directories::getLocation("resources/assets/facebook.png"),
    "twitter" =>
    Directories::getLocation("resources/assets/twitter.png"),
    "instagram" =>
    Directories::getLocation("resources/assets/instagram.png"),
    "linkedin" =>
    Directories::getLocation("resources/assets/linkedin.png"),
    "youtube" =>
    Directories::getLocation("resources/assets/youtube.png"),
    "delete" =>
    Directories::getLocation("resources/assets/delete.png"),
    "shopping-cart" =>
    Directories::getLocation("resources/assets/shopping-cart.png"),
    "register" =>
    Directories::getLocation("resources/assets/edit.png"),
    "login" =>
    Directories::getLocation("resources/assets/login.png"),
    "cancel" =>
    Directories::getLocation("resources/assets/cancel.png"),
    "man" =>
    Directories::getLocation("resources/assets/man3.png"),
    "woman" =>
    Directories::getLocation("resources/assets/beauty.png"),
    "pending" =>
    Directories::getLocation("resources/assets/pending.png"),
    "verified" =>
    Directories::getLocation("resources/assets/accept.png"),
    "payment" =>
    Directories::getLocation("resources/assets/payment-method.png"),
